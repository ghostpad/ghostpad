...
umamba.exe install --no-shortcuts -r B:\python\ -n base -f "%~dp0\environments\cpu.yml" -y --always-copy
...
umamba.exe install --no-shortcuts -r miniconda3 -n base -f environments\cpu.yml -y --always-copy
